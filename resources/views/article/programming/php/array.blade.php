...
<h2 id="1dime-array" class="heading title-2">1次元配列の基本操作</h2>
<h3 class="heading title-3">空の1次元配列の作成</h3>
...
<h3 class="heading title-3">1次元配列の作成・初期化（添字配列の場合）</h3>
...
<h3 class="heading title-3">1次元配列の作成・初期化（連想配列の場合）</h3>
...
<h2 id="2dime-array" class="heading title-2">2次元配列の基本操作</h2>
<h3 class="heading title-3">2次元配列の作成・初期化（添字配列の場合）</h3>
<h4 class="heading desc">array()で添字配列を作成・初期化する</h4>
...
<h3 class="heading title-3">2次元配列の作成・初期化（連想配列の場合）</h3>
<h4 class="heading desc">array()で連想配列を作成・初期化する</h4>
...
<h2 id="string" class="heading title-2">配列と文字列</h2>
<h3 class="heading title-3">文字列への展開</h3>
...
<h2 id="function" class="heading title-2">配列と関数</h2>
<h3 class="heading title-3">関数への参照渡し</h3>
...
<h2 id="convenient-oper" class="heading title-2">配列の便利な操作</h2>
<h3 class="heading title-3">配列の分解（list構文の場合）</h3>
...
list(, , $color_3) = $colors;
echo $color_3, PHP_EOL;  # blue</code></pre>
<h3 class="heading title-3">配列の分解（短縮構文の場合）</h3>
<h4 class="heading desc">配列から複数の変数に代入する</h4>
<pre class="code-block"><code class="php">$colors = ['red', 'green', 'blue'];
...
[, , $color_3] = $colors;
echo $color_3, PHP_EOL;  # blue</code></pre>
<h2 id="convenient-func" class="heading title-2">配列の便利な関数</h2>
<h3 class="heading title-3">count関数</h3>
