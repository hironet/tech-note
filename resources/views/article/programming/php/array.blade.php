...
<h4 class="oper">array()で連想配列を作成・初期化する</h4>
...
<h4 class="oper">短縮構文で連想配列を作成・初期化する</h4>
...
<h4 class="oper">配列の参照を関数に渡し、関数内で配列の値を変更する</h4>
...
<h4 class="oper">配列の要素数をカウントする</h4>
<pre class="block"><code class="php">$colors = ['red', 'green', 'blue'];
